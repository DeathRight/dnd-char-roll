...
export function interpolate(
  fromShape: Shape,
  toShape: Shape,
  options?: InterpolateToStringOptions
): (t: number) => string;
export function interpolate(
  fromShape: Shape,
  toShape: Shape,
  options: InterpolateToPointsOptions
): (t: number) => Point[];
...
export function separate(
  fromShape: Shape,
  toShapeList: Shape[],
  options?: MultipleInterpolateToStringOptions
): ((t: number) => string)[];
export function separate(
  fromShape: Shape,
  toShapeList: Shape[],
  options: MultipleInterpolateToPointsOptions
): ((t: number) => Point[])[];
export function separate(
  fromShape: Shape,
  toShapeList: Shape[],
  options: SingleInterpolateToStringOptions
): (t: number) => string;
export function separate(
  fromShape: Shape,
  toShapeList: Shape[],
  options: SingleInterpolateToPointsOptions
): (t: number) => Point[];
